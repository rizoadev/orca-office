// ============================================================
// Coffee-shop naming & formatting — port dari lib/coffee-menu.ts
// Setiap LLM model dapat nama minuman di papan menu.
// Penamaan murni presentation — server tetap model-agnostic.
// ============================================================

import { CostSource } from '../models/types';

/** Urutan cadangan kalau nama favorit sudah kepakai di menu. */
const HOUSE_MENU = [
  'Espresso', 'Americano', 'Cappuccino', 'Latte', 'Mocha', 'Piccolo',
  'Flat White', 'Long Black', 'Cortado', 'Macchiato', 'Ristretto',
  'Doppio', 'Lungo', 'Affogato', 'Cold Brew', 'Nitro Cold Brew',
  'Vietnam Drip', 'Con Panna', 'Café Touba', 'Breve',
];
